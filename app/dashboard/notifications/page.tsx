...
export default function NotificationsPage() {
  ...
  const handleSaveSettings = () => {
    toast({
      ...
      description: `La configuración de notificaciones para ${currentTenant?.name} ha sido actualizada.`,
    });
  };
  ...
  const handleTestNotification = (type: string) => {
    toast({
      ...
      description: `Se ha enviado una notificación de prueba por ${type} para ${currentTenant?.name}.`,
    });
  };
    ...
    <div>
      <div className="flex flex-col gap-2 mb-8">
        ...
        <p className="text-muted-foreground">
          Configura y gestiona tus notificaciones para {currentTenant?.name}
        </p>
      </div>
      ...
      <Tabs defaultValue="settings">
        ...
        <TabsContent value="templates">
          <NotificationTemplates tenantId={currentTenant?.id} />
        </TabsContent>

        <TabsContent value="history">
          <NotificationHistory tenantId={currentTenant?.id} />
        </TabsContent>
      </Tabs>
    </div>
  );
